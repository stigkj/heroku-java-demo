...
<div class="jumbotron text-center">
  <div class="container">
    ...
    <h1>Getting Started with Java on the amazing Heroku platform</h1>
    <p>This is a sample Java application deployed to amazing Heroku. It's a reasonably simple app - but a good foundation for understanding how to get the most out of the Heroku platform.</p>
